...
Σύστημα Ειδοποιήσεων: Ηχητικές (Buzzer) και οπτικές (LEDs, LCD) ειδοποιήσεις, καθώς και αποστολή συμβάντων στο Dashboard.
...
Το σύστημα θα συνδεθεί αυτόματα στο WiFi και θα αρχίσει να στέλνει δεδομένα τηλεμετρίας (bus/bus01/telemetry) και συμβάντα (bus/bus01/event) στον MQTT broker.
